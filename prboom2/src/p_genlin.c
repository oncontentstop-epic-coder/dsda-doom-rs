...
int EV_DoGenCeiling(line_t *line) {
  ...
  manual_ceiling:
    ...
    case CbyST:
      targheight =
          (ceiling->sector->ceilingheight >> FRACBITS) +
    ...
    case Cby24:
      targheight =
          ceiling->sector->ceilingheight + ceiling->direction * 24 * FRACUNIT;
      break;
    case Cby32:
      targheight =
          ceiling->sector->ceilingheight + ceiling->direction * 32 * FRACUNIT;
      break;
    default:
      break;
    }

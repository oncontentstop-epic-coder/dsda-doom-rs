...
weaponinfo_t doom_weaponinfo[NUMWEAPONS + 2] = {
    {// fist
     am_noammo, S_PUNCHUP, S_PUNCHDOWN, S_PUNCH, S_PUNCH1, S_NULL, S_NULL},
    {// pistol
     am_clip, S_PISTOLUP, S_PISTOLDOWN, S_PISTOL, S_PISTOL1, S_NULL,
     S_PISTOLFLASH},
    {// shotgun
     am_shell, S_SGUNUP, S_SGUNDOWN, S_SGUN, S_SGUN1, S_NULL, S_SGUNFLASH1},
    {// chaingun
     am_clip, S_CHAINUP, S_CHAINDOWN, S_CHAIN, S_CHAIN1, S_NULL, S_CHAINFLASH1},
    {// missile launcher
     am_misl, S_MISSILEUP, S_MISSILEDOWN, S_MISSILE, S_MISSILE1, S_NULL,
     S_MISSILEFLASH1},
    {// plasma rifle
     am_cell, S_PLASMAUP, S_PLASMADOWN, S_PLASMA, S_PLASMA1, S_NULL,
     S_PLASMAFLASH1},
    {// bfg 9000
     am_cell, S_BFGUP, S_BFGDOWN, S_BFG, S_BFG1, S_NULL, S_BFGFLASH1},
    {// chainsaw
     am_noammo, S_SAWUP, S_SAWDOWN, S_SAW, S_SAW1, S_NULL, S_NULL},
    {// super shotgun
     am_shell, S_DSGUNUP, S_DSGUNDOWN, S_DSGUN, S_DSGUN1, S_NULL,
     S_DSGUNFLASH1},
    ...
    // dseg03:00082E68                 db 'N', 'U', 'K', 'A', 'G', 'E', '3', 2
    // dup(0); endname
    // dseg03:00082E68                 db 'N', 'U', 'K', 'A', 'G', 'E', '1', 2
    // dup(0); startname
    ...
    {// preved medved weapon
     0, S_NULL, S_NULL, S_NULL, S_NULL, S_NULL, S_NULL},
};

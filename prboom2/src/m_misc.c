...
default_t defaults[] = {
    ...
    {"max_player_corpse",
     ...
     UL, // killough 2/8/98
     def_int,
     ss_none}, // number of dead bodies in view supported (-1 = no limit)
    {"flashing_hom",
     {&flashing_hom},
     {0},
     0,
    ...
    {"endoom_mode",
     ...
     {5},
     0,
     7, // CPhipps - endoom flags
     def_hex,
     ss_none}, // 0, +1 for colours, +2 for non-ascii chars, +4 for
               // skip-last-line
    {"level_precache",
     {(int *)&precache},
     {1},
    ...
    {"default_skill",
     ...
     {3},
     1,
     5, // jff 3/24/98 allow default skill setting
     def_int,
     ss_none}, // selects default skill 1=TYTD 2=NTR 3=HMP 4=UV 5=NM
    ...
    {"sts_always_red",
     ...
     {1},
     0,
     1, // no color changes on status bar
     def_bool,
     ss_stat},
    {"sts_pct_always_gray",
     {&sts_pct_always_gray},
     {0},
     0,
     1, // 2/23/98 chg default
     def_bool,
     ss_stat}, // makes percent signs on status bar always gray
    {"sts_traditional_keys",
     ...
     1, // killough 2/28/98
     def_bool,
     ss_stat}, // disables doubled card and skull key display on status bar
    {"sts_armorcolor_type",
     {&sts_armorcolor_type},
     {1},
     0,
     1, //  armor color depends on type
     def_bool,
     ss_stat},
    {"show_messages",
     {&showMessages},
     ...
     1,
     def_bool,
     ss_none}, // enables message display
    {"autorun",
     {&autorun},
     {1},
     0,
    ...
    {"sound_card",
     ...
     {-1},
     -1,
     7, // jff 1/18/98 allow Allegro drivers
     def_int,
     ss_none}, // select sounds driver (DOS), -1 is autodetect, 0 is none; in
               // Linux, non-zero enables sound
    {"music_card",
     {&mus_card},
     {-1},
     -1,
     9, //  to be set,  -1 = autodetect
     def_int,
     ss_none}, // select music driver (DOS), -1 is autodetect, 0 is none"; in
    ...
    {"pitched_sounds",
     ...
     1, // killough 2/21/98
     def_bool,
     ss_none}, // enables variable pitch in sound effects (from id's original
               // code)
    ...
    {"mus_pause_opt",
     ...
     {1},
     0,
     2, // CPhipps - music pausing
     def_int,
     ss_none}, // 0 = kill music when paused, 1 = pause music, 2 = let music
               // continue
    {"snd_channels",
     {&default_numChannels},
     {32},
    ...
    {"snd_soundfont",
     {NULL, &snd_soundfont},
     {0, "/usr/share/sounds/sf3/default-GM.sf3"},
     UL,
     UL,
     def_str,
     ss_none}, // soundfont name for synths that support it
    ...
    {"snd_mididev",
     ...
     UL,
     def_str,
     ss_none}, // midi device to use for portmidiplayer
    ...
    {"translucency",
     ...
     1, // phares
     def_bool,
     ss_none}, // enables translucency
    {"tran_filter_pct",
     {&tran_filter_pct},
     {66},
     0,
     100, // killough 2/21/98
     def_int,
     ss_none}, // set percentage of foreground/background translucency mix
    {"screenblocks",
     {&screenblocks},
     {10},
     3,
     11, // killough 2/21/98: default to 10
     def_int,
     ss_none},
    {"usegamma",
     {&usegamma},
     {0},
     0,
     4, // jff 3/6/98 fix erroneous upper limit in range
     def_int,
     ss_none}, // gamma correction level // killough 1/18/98
    {"uncapped_framerate",
     {&movement_smooth_default},
     {1},
     0,
     1,
     def_bool,
    ...
    {"gl_nearclip",
     ...
     UL,
     def_int,
     ss_none}, /* near clipping plane pos */
    {"gl_colorbuffer_bits",
     {&gl_colorbuffer_bits},
     {32},
     16,
    ...
    {"gl_texture_filter_anisotropic",
     {(int *)&gl_texture_filter_anisotropic},
     {gl_anisotropic_8x},
     gl_anisotropic_off,
     gl_anisotropic_16x,
     def_int,
    ...
    {"mapcolor_back",
     ...
     {247},
     0,
     255, // black //jff 4/6/98 new black
     def_colour,
     ss_auto}, // color used as background for automap
    {"mapcolor_grid",
     {&mapcolor_grid},
     {104},
     0,
     255, // dk gray
     def_colour,
     ss_auto}, // color used for automap grid lines
    {"mapcolor_wall",
     {&mapcolor_wall},
     {23},
     0,
     255, // red-brown
     def_colour,
     ss_auto}, // color used for one side walls on automap
    {"mapcolor_fchg",
     {&mapcolor_fchg},
     {55},
     0,
     255, // lt brown
     def_colour,
     ss_auto}, // color used for lines floor height changes across
    {"mapcolor_cchg",
     {&mapcolor_cchg},
     {215},
     0,
     255, // orange
     def_colour,
     ss_auto}, // color used for lines ceiling height changes across
    {"mapcolor_clsd",
     {&mapcolor_clsd},
     {208},
     0,
     255, // white
     def_colour,
     ss_auto}, // color used for lines denoting closed doors, objects
    {"mapcolor_rkey",
     {&mapcolor_rkey},
     {175},
     0,
     255, // red
     def_colour,
     ss_auto}, // color used for red key sprites
    {"mapcolor_bkey",
     {&mapcolor_bkey},
     {204},
     0,
     255, // blue
     def_colour,
     ss_auto}, // color used for blue key sprites
    {"mapcolor_ykey",
     {&mapcolor_ykey},
     {231},
     0,
     255, // yellow
     def_colour,
     ss_auto}, // color used for yellow key sprites
    {"mapcolor_rdor",
     {&mapcolor_rdor},
     {175},
     0,
     255, // red
     def_colour,
     ss_auto}, // color used for closed red doors
    {"mapcolor_bdor",
     {&mapcolor_bdor},
     {204},
     0,
     255, // blue
     def_colour,
     ss_auto}, // color used for closed blue doors
    {"mapcolor_ydor",
     {&mapcolor_ydor},
     {231},
     0,
     255, // yellow
     def_colour,
     ss_auto}, // color used for closed yellow doors
    {"mapcolor_tele",
     {&mapcolor_tele},
     {119},
     0,
     255, // dk green
     def_colour,
     ss_auto}, // color used for teleporter lines
    {"mapcolor_secr",
     {&mapcolor_secr},
     {252},
     0,
     255, // purple
     def_colour,
     ss_auto}, // color used for lines around secret sectors
    {"mapcolor_exit",
     {&mapcolor_exit},
     {0},
     0,
     255, // none
     def_colour,
     ss_auto}, // color used for exit lines
    {"mapcolor_unsn",
     {&mapcolor_unsn},
     {104},
     0,
     255, // dk gray
     def_colour,
     ss_auto}, // color used for lines not seen without computer map
    {"mapcolor_flat",
     {&mapcolor_flat},
     {88},
     0,
     255, // lt gray
     def_colour,
     ss_auto}, // color used for lines with no height changes
    {"mapcolor_sprt",
     {&mapcolor_sprt},
     {112},
     0,
    ...
    {"mapcolor_item",
     ...
     255, // yellow
     def_colour,
     ss_auto}, // color used for counted items
    {"mapcolor_hair",
     {&mapcolor_hair},
     {208},
     0,
     255, // white
     def_colour,
     ss_auto}, // color used for dot crosshair denoting center of map
    {"mapcolor_sngl",
     {&mapcolor_sngl},
     {208},
     0,
     255, // white
     def_colour,
     ss_auto}, // color used for the single player arrow
    {"mapcolor_me",
     {&mapcolor_me},
     {112},
     0,
    ...
    {"map_secret_after",
     ...
     {0},
     0,
     1, // show secret after gotten
     def_bool,
     ss_auto}, // prevents showing secret sectors till after entered
    ...
    {"automapmode",
     ...
     {am_follow},
     0,
     31, // CPhipps - remember automap mode
     def_hex,
     ss_none}, // automap mode
    ...
    {"hudcolor_titl",
     ...
     9, // gold range
     def_int,
     ss_auto}, // color range used for automap level title
    {"hudcolor_xyco",
     {&hudcolor_xyco},
     {3},
     0,
     9, // green range
     def_int,
     ss_auto}, // color range used for automap coordinates
    {"hudcolor_mapstat_title",
     ...
     9, // red range
     def_int,
     ss_auto}, // color range used for automap statistics for titles
    {"hudcolor_mapstat_value",
     ...
     9, // gray range
     def_int,
     ss_auto}, // color range used for automap statistics for data
    {"hudcolor_mapstat_time",
     ...
     9, // gray range
     def_int,
     ss_auto}, // color range used for automap statistics for level time and
               // total time
    {"hudcolor_mesg",
     {&hudcolor_mesg},
     {6},
     ...
     9, // red range
     def_int,
     ss_mess}, // color range used for messages during play
    {"hudcolor_chat",
     {&hudcolor_chat},
     {5},
     0,
     9, // gold range
     def_int,
     ss_mess}, // color range used for chat messages and entry
    {"hudcolor_list",
     {&hudcolor_list},
     {5},
     0,
     9, // gold range  //jff 2/26/98
     def_int,
     ss_mess}, // color range used for message review
    {"hud_msg_lines",
     {&hud_msg_lines},
     {1},
     1,
     16, // 1 line scrolling window
     def_int,
     ss_mess}, // number of messages in review display (1=disable)
    {"hud_list_bgon",
     {&hud_list_bgon},
     {0},
     0,
     1, // solid window bg ena //jff 2/26/98
     def_bool,
     ss_mess}, // enables background window behind message review
    ...
    {"health_red",
     ...
     200, // below is red
     def_int,
     ss_stat}, // amount of health for red to yellow transition
    {"health_yellow",
     {&health_yellow},
     {50},
     0,
     200, // below is yellow
     def_int,
     ss_stat}, // amount of health for yellow to green transition
    {"health_green",
     {&health_green},
     {100},
     0,
     200, // below is green, above blue
     def_int,
     ss_stat}, // amount of health for green to blue transition
    {"armor_red",
     {&armor_red},
     {25},
     0,
     200, // below is red
     def_int,
     ss_stat}, // amount of armor for red to yellow transition
    {"armor_yellow",
     {&armor_yellow},
     {50},
     0,
     200, // below is yellow
     def_int,
     ss_stat}, // amount of armor for yellow to green transition
    {"armor_green",
     {&armor_green},
     {100},
     0,
     200, // below is green, above blue
     def_int,
     ss_stat}, // amount of armor for green to blue transition
    {"ammo_red",
     {&ammo_red},
     {25},
     0,
     100, // below 25% is red
     def_int,
     ss_stat}, // percent of ammo for red to yellow transition
    {"ammo_yellow",
     {&ammo_yellow},
     {50},
     0,
     100, // below 50% is yellow, above green
     def_int,
     ss_stat}, // percent of ammo for yellow to green transition
    {"ammo_colour_behaviour",
     {(int *)&ammo_colour_behaviour},
     {ammo_colour_behaviour_max -
      1}, // whether backpack changes thresholds above
     0,
     ammo_colour_behaviour_max - 1,
     def_int,
     ss_stat},
    ...
    {"hud_displayed",
     ...
     {0},
     0,
     1, // whether hud is displayed
     def_bool,
     ss_none}, // enables display of HUD
    ...
    {"Prboom-plus 'bad' compatibility settings",
     ...
     ss_none},
    {"comperr_zerotag",
     {&default_comperr[comperr_zerotag]},
     {0},
     0,
     1,
     def_bool,
    ...
    {"comperr_passuse",
     ...
     ss_stat},
    {"comperr_hangsolid",
     {&default_comperr[comperr_hangsolid]},
     {0},
     0,
     1,
     def_bool,
     ss_stat},
    {"comperr_blockmap",
     {&default_comperr[comperr_blockmap]},
     {0},
     0,
     1,
     def_bool,
     ss_stat},
    {"comperr_allowjump",
     {&default_comperr[comperr_allowjump]},
     {0},
     0,
     2,
     def_int,
     ss_stat},
    {"comperr_freeaim",
     {&default_comperr[comperr_freeaim]},
     {0},
     0,
     1,
     def_bool,
  ...
  for (i = 0; i < numdefaults; i++) {
    if (defaults[i].type == def_none) {
      ...
      i += defaults[i].defaultvalue.array_size;
        ...
        if (!IS_STRING(
                defaults[i])) // jff 4/10/98 kill super-hack on pointer value
    {
          ...
          if ((defaults[i].type != def_none) &&
            ...
            if (!isstring) {
              if (defaults[i].type == def_input) {
                ...
                do {
                  count =
                      sscanf(config_scan_p, "%79s %d %d", keys, &mouseb, &joyb);
                  ...
                  dsda_InputAddSpecificMouseB(index, defaults[i].identifier,
                                              mouseb);
                  dsda_InputAddSpecificJoyB(index, defaults[i].identifier,
                                            joyb);
                  ...
                  do {
                    ...
                    dsda_InputAddSpecificKey(index, defaults[i].identifier,
                                             key);
              ...
              else if ((defaults[i].minvalue == UL ||

...
void I_InitMusic(void) {
  ...
  return;
#endif
  lprintf(LO_INFO, "I_InitMusic: Was compiled without SDL_Mixer support.  You "
                   "should enable experimental music.\n");
}
...
static const music_player_t *music_players[] =
    { // until some ui work is done, the order these appear is the autodetect
      // order. of particular importance:  things that play mus have to be last,
      // because mus2midi very often succeeds even on garbage input

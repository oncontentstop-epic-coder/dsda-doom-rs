...
void I_CapturePrep(const char *fn) {
  ...
  soundpipe.outthread =
      SDL_CreateThread(threadstdoutproc, "soundpipe.outthread", &soundpipe);
  soundpipe.errthread =
      SDL_CreateThread(threadstderrproc, "soundpipe.errthread", &soundpipe);
  videopipe.stdoutdumpname = "video_stdout.txt";
  videopipe.stderrdumpname = "video_stderr.txt";
  videopipe.outthread =
      SDL_CreateThread(threadstdoutproc, "videopipe.outthread", &videopipe);
  videopipe.errthread =
      SDL_CreateThread(threadstderrproc, "videopipe.errthread", &videopipe);
...
void I_CaptureFinish(void) {
  ...
  // write end of soundpipe_stdin (so that stream will never see EOF). is there
  ...
  muxpipe.outthread =
      SDL_CreateThread(threadstdoutproc, "muxpipe.outthread", &muxpipe);
  muxpipe.errthread =
      SDL_CreateThread(threadstderrproc, "muxpipe.errthread", &muxpipe);

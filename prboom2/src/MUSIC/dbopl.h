...
// Use 8 handlers based on a small logatirmic wavetabe and an exponential table
// for volume
...
struct _Channel {
  ...
  Bit8u regC0;
  // This should correspond with reg104, bit 6 indicates a Percussion channel,
  // bit 7 indicates a silent channel
  Bit8u fourMask;
